                ...
                <div className="details col-5">
                    <div className="card-detail my-4">
                        <div className="card-detail-content">
                            ...
                            <a href="#" className="card-link"> <i className="fab fa-instagram"></i> {store.currentUser?.instagram}</a>
                            <a href="#" className="card-link"><i className="fab fa-tiktok"></i> {store.currentUser?.tiktok}</a>
                        </div>
                    </div>
                    <div className="card-detail my-4">
                        <div className="card-detail-content">
                            <h5 className="card-title">Información</h5>
                            <p className="card-text">{store.currentUser?.cityr}</p>

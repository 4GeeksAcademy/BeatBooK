            ...
            <div className="row">
                <div className="col-12 m-0 p-0 position-relative">
                    ...
                    <div className="overlay-text">
                        <p className="mb-3">Conecta con músicos y locales, crea eventos y da vida a la música en tu comunidad.<br /> <strong>¡Sé parte del movimiento!</strong></p>
                        <Link to="/home">
                            <button className='btns-landing'>Hazte Escuchar</button>
                        </Link>
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-md-12 d-flex justify-content-center mx-3">
